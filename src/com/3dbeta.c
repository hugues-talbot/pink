/* $Id: 3dbeta.c,v 1.1.1.1 2008-11-25 08:01:39 mcouprie Exp $ */
/*! \file 3dbeta.c

\brief beta-dilation of a 3d khalimsky order 

<B>Usage:</B> 3dbeta in.pgm out.pgm
...
/* =============================================================== */
{
  ...
  if (! l3dbeta(k))
  {
    fprintf(stderr, "%s: function l3dbeta failed\n", argv[0]);
    exit(1);
  }
