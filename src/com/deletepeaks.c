/* $Id: deletepeaks.c,v 1.1.1.1 2008-11-25 08:01:37 mcouprie Exp $ */
/*! \file deletepeaks.c

\brief deletes peaks in a grayscale image 

<B>Usage:</B> deletepeaks filein.pgm [mask] connexmin fileout.pgm
  ...
  int argc; char **argv; 
{
  ...
  if ((connexmin == 4) || (connexmin == 8))
  {
    ...
    {
      fprintf(stderr, "%s: function ldespics failed\n");
      exit(1);
    }
  }
