/* $Id: desfilssombres3d.c,v 1.1.1.1 2008-11-25 08:01:39 mcouprie Exp $ */
/* \file desfilssombres3d.c
  ...
  int argc; char **argv; 
{
  ...
  if (! ldesfilssombres3d(image, mask, connexmin))
  {
    fprintf(stderr, "%s: function ldesfilssombres3d failed\n", argv[0]);
    exit(1);
  }
