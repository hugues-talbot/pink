/* $Id: ldilatplan.c,v 1.1.1.1 2008-11-25 08:01:41 mcouprie Exp $ */
...
/* ==================================== */
int32_t ldilatplan(struct xvimage *f, struct xvimage *m, int32_t xc, int32_t yc)
...
/* ==================================== */
{
  ...
  if (depth(f) != 1) 
  {
    fprintf(stderr, "ldilatplan: cette version ne traite pas les images volumiques\n");
    return 0;
  }
  ...
  if (H == NULL)
  {  
     fprintf(stderr,"ldilatplan() : malloc failed for H\n");
     return(0);
  }
  ...
  {  
     fprintf(stderr,"ldilatplan() : malloc failed for tab_es\n");
     return(0);
  }
...
/* ==================================== */
int32_t ldilatplan2(struct xvimage *f, int32_t nptb, int32_t *tab_es_x, int32_t *tab_es_y, int32_t xc, int32_t yc)
...
/* ==================================== */
{
  ...
  if (depth(f) != 1) 
  {
    fprintf(stderr, "ldilatplan2: cette version ne traite pas les images volumiques\n");
    return 0;
  }
  ...
  if (H == NULL)
  {  
     fprintf(stderr,"ldilatplan2() : malloc failed for H\n");
     return(0);
  }
