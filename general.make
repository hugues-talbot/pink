...
$(BDIR)/car2pol:	$(CDIR)/car2pol.c $(IDIR)/mcimage.h $(IDIR)/lgeo.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcgeo.o $(ODIR)/mcliste.o $(ODIR)/lbresen.o $(ODIR)/llabelextrema.o $(ODIR)/lgeo.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/car2pol.c $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcgeo.o $(ODIR)/mcliste.o $(ODIR)/lbresen.o $(ODIR)/llabelextrema.o $(ODIR)/lgeo.o $(LIBS) -o $(BDIR)/car2pol
...
$(BDIR)/pol2car:	$(CDIR)/pol2car.c $(IDIR)/mcimage.h $(IDIR)/lgeo.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcgeo.o $(ODIR)/mcliste.o $(ODIR)/lbresen.o $(ODIR)/llabelextrema.o $(ODIR)/lgeo.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/pol2car.c $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcgeo.o $(ODIR)/mcliste.o $(ODIR)/lbresen.o $(ODIR)/llabelextrema.o $(ODIR)/lgeo.o $(LIBS) -o $(BDIR)/pol2car
...
$(BDIR)/sceneconvert:	$(CDIR)/sceneconvert.c $(IDIR)/mcmesh.h $(IDIR)/mciomesh.h $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(ODIR)/mcrbt1.o $(ODIR)/mcgeo.o $(ODIR)/mcprobas.o $(OBJ_COMMON)
			$(CC) $(CCFLAGS) -I$(IDIR) -I. $(CDIR)/sceneconvert.c $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(ODIR)/mcrbt1.o $(ODIR)/mcgeo.o $(ODIR)/mcprobas.o  $(OBJ_COMMON) $(LIBS) -o $(BDIR)/sceneconvert
...
$(BDIR)/section:	$(CDIR)/section.c $(IDIR)/mcimage.h $(IDIR)/lgeo.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcgeo.o $(ODIR)/mcliste.o $(ODIR)/lbresen.o $(ODIR)/llabelextrema.o $(ODIR)/lgeo.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/section.c $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcgeo.o $(ODIR)/mcliste.o $(ODIR)/lbresen.o $(ODIR)/llabelextrema.o $(ODIR)/lgeo.o $(LIBS) -o $(BDIR)/section
...
$(BDIR)/asft:	$(CDIR)/asft.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lasft.h $(IDIR)/ldilateros.h $(IDIR)/ldilateros3d.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/ldilateros.o $(ODIR)/ldilateros3d.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/mcfah.o $(ODIR)/mcindic.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/lasft.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/asft.c $(ODIR)/ldilateros.o $(ODIR)/ldilateros3d.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o $(ODIR)/mccodimage.o $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/mcfah.o $(ODIR)/mcindic.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/lasft.o $(LIBS) -o $(BDIR)/asft
...
$(BDIR)/dynamique:	$(CDIR)/dynamique.c $(IDIR)/mcimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfahsalembier.h $(IDIR)/mccomptree.h $(IDIR)/llabelextrema.h $(IDIR)/mccodimage.h $(IDIR)/ldynamique.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccomptree.o $(ODIR)/mcunionfind.o $(ODIR)/llabelextrema.o $(ODIR)/mccodimage.o $(ODIR)/ldynamique.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/dynamique.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccomptree.o $(ODIR)/mcunionfind.o $(ODIR)/llabelextrema.o $(ODIR)/mccodimage.o $(ODIR)/ldynamique.o $(LIBS) -o $(BDIR)/dynamique
...
$(BDIR)/dynamiquefilter:	$(CDIR)/dynamiquefilter.c $(IDIR)/mcimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfahsalembier.h $(IDIR)/mccomptree.h $(IDIR)/llabelextrema.h $(IDIR)/mccodimage.h $(IDIR)/ldynamique.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccomptree.o $(ODIR)/mcunionfind.o $(ODIR)/llabelextrema.o $(ODIR)/mccodimage.o $(ODIR)/ldynamique.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/dynamiquefilter.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccomptree.o $(ODIR)/mcunionfind.o $(ODIR)/llabelextrema.o $(ODIR)/mccodimage.o $(ODIR)/ldynamique.o $(LIBS) -o $(BDIR)/dynamiquefilter
...
$(BDIR)/medialaxis:	$(CDIR)/medialaxis.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lmedialaxis.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/medialaxis.c $(ODIR)/mccodimage.o $(OBJ_COMMON) $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/medialaxis

$(BDIR)/lambdamedialaxis:	$(CDIR)/lambdamedialaxis.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lmedialaxis.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/lambdamedialaxis.c $(ODIR)/mccodimage.o $(OBJ_COMMON) $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/lambdamedialaxis
...
$(BDIR)/areaclosing:	$(CDIR)/areaclosing.c $(IDIR)/mcimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfahsalembier.h $(IDIR)/mccodimage.h $(IDIR)/lattribarea.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribarea.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/areaclosing.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribarea.o $(LIBS) -o $(BDIR)/areaclosing

$(BDIR)/areaopening:	$(CDIR)/areaopening.c $(IDIR)/mcimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfahsalembier.h $(IDIR)/mccodimage.h $(IDIR)/lattribarea.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribarea.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/areaopening.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribarea.o $(LIBS) -o $(BDIR)/areaopening

$(BDIR)/areaselnb:	$(CDIR)/areaselnb.c $(IDIR)/mcimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfahsalembier.h $(IDIR)/mccodimage.h $(IDIR)/lattribarea.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribarea.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/areaselnb.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribarea.o $(LIBS) -o $(BDIR)/areaselnb
...
$(BDIR)/heightmaxima:	$(CDIR)/heightmaxima.c $(IDIR)/mcimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfahsalembier.h $(IDIR)/mccodimage.h $(IDIR)/lattribheight.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribheight.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/heightmaxima.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribheight.o $(LIBS) -o $(BDIR)/heightmaxima

$(BDIR)/heightminima:	$(CDIR)/heightminima.c $(IDIR)/mcimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfahsalembier.h $(IDIR)/mccodimage.h $(IDIR)/lattribheight.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribheight.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/heightminima.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribheight.o $(LIBS) -o $(BDIR)/heightminima

$(BDIR)/heightselnb:	$(CDIR)/heightselnb.c $(IDIR)/mcimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfahsalembier.h $(IDIR)/mccodimage.h $(IDIR)/lattribheight.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribheight.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/heightselnb.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribheight.o $(LIBS) -o $(BDIR)/heightselnb
...
$(BDIR)/reconsdilat:	$(CDIR)/reconsdilat.c $(IDIR)/mcimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfahsalembier.h $(IDIR)/mccodimage.h $(IDIR)/mccomptree.h $(IDIR)/lwshedtopo.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/mccomptree.o $(ODIR)/mcunionfind.o $(ODIR)/lwshedtopo.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/reconsdilat.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/mccomptree.o $(ODIR)/mcunionfind.o $(ODIR)/lwshedtopo.o $(LIBS) -o $(BDIR)/reconsdilat

$(BDIR)/segment:	$(CDIR)/segment.c $(IDIR)/mcimage.h $(IDIR)/llabelextrema.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mccbt.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcxbib.h $(IDIR)/lsegment.h $(OBJ_COMMON) $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcxbib.o $(ODIR)/lsegment.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/segment.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcxbib.o $(ODIR)/lsegment.o $(XLIB) $(LIBS) -o $(BDIR)/segment

$(BDIR)/segmentc:	$(CDIR)/segment.c $(IDIR)/mcimage.h $(IDIR)/llabelextrema.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mccbt.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcxbib.h $(IDIR)/lsegment.h $(OBJ_COMMON) $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcxbib.o $(ODIR)/lsegmentc.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/segment.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcxbib.o $(ODIR)/lsegmentc.o $(XLIB) $(LIBS) -o $(BDIR)/segmentc

$(BDIR)/segment3d:	$(CDIR)/segment3d.c $(IDIR)/mcimage.h $(IDIR)/llabelextrema.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mccbt.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/lsegment3d.h $(OBJ_COMMON) $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/lsegment3d.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/segment3d.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/lsegment3d.o $(LIBS) -o $(BDIR)/segment3d

$(BDIR)/segment3di:	$(CDIR)/segment3di.c $(IDIR)/mcxbib.h $(IDIR)/mcimage.h $(IDIR)/llabelextrema.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mccbt.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/lsegment.h $(ODIR)/mcxbib.o $(OBJ_COMMON) $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/lsegment3di.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/segment3di.c $(ODIR)/mcxbib.o $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/lsegment3di.o $(XLIB) $(LIBS) -o $(BDIR)/segment3di

$(BDIR)/segment3dic:	$(CDIR)/segment3di.c $(IDIR)/mcxbib.h $(IDIR)/mcimage.h $(IDIR)/llabelextrema.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mccbt.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/lsegment.h $(ODIR)/mcxbib.o $(OBJ_COMMON) $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/lsegment3dic.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/segment3di.c $(ODIR)/mcxbib.o $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/lsegment3dic.o $(XLIB) $(LIBS) -o $(BDIR)/segment3dic

$(BDIR)/segmentarea:	$(CDIR)/segmentarea.c $(IDIR)/mcimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfahsalembier.h $(IDIR)/mccodimage.h $(IDIR)/lattribarea.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribarea.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/segmentarea.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribarea.o $(LIBS) -o $(BDIR)/segmentarea

$(BDIR)/segmentheight:	$(CDIR)/segmentheight.c $(IDIR)/mcimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfahsalembier.h $(IDIR)/mccodimage.h $(IDIR)/lattribarea.h $(IDIR)/lsegreconsheight.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribheight.o $(ODIR)/lsegreconsheight.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/segmentheight.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribheight.o $(ODIR)/lsegreconsheight.o $(LIBS) -o $(BDIR)/segmentheight

$(BDIR)/segmentnum:	$(CDIR)/segmentnum.c $(IDIR)/mcimage.h $(IDIR)/llabelplateaux.h $(IDIR)/mclifo.h $(IDIR)/mcfah.h $(IDIR)/mccbt.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/lsegmentnum.h $(OBJ_COMMON) $(ODIR)/llabelplateaux.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/lsegmentnum.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/segmentnum.c $(OBJ_COMMON) $(ODIR)/llabelplateaux.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/lsegmentnum.o $(LIBS) -o $(BDIR)/segmentnum

$(BDIR)/segmentnumi:	$(CDIR)/segmentnumi.c $(IDIR)/mcxbib.h $(IDIR)/mcimage.h $(IDIR)/llabelplateaux.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mccbt.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/lsegment.h $(ODIR)/mcxbib.o $(OBJ_COMMON) $(ODIR)/llabelplateaux.o $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/lsegmentnumi.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/segmentnumi.c $(ODIR)/mcxbib.o $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/llabelplateaux.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/lsegmentnumi.o $(XLIB) $(LIBS) -o $(BDIR)/segmentnumi

$(BDIR)/segmentnumic:	$(CDIR)/segmentnumi.c $(IDIR)/mcxbib.h $(IDIR)/mcimage.h $(IDIR)/llabelplateaux.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mccbt.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/lsegment.h $(ODIR)/mcxbib.o $(OBJ_COMMON) $(ODIR)/llabelplateaux.o $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/lsegmentnumic.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/segmentnumi.c $(ODIR)/mcxbib.o $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/llabelplateaux.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/lsegmentnumic.o $(XLIB) $(LIBS) -o $(BDIR)/segmentnumic

$(BDIR)/segmentvol:	$(CDIR)/segmentvol.c $(IDIR)/mcimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfahsalembier.h $(IDIR)/mccodimage.h $(IDIR)/lattribvol.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribvol.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/segmentvol.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribvol.o $(LIBS) -o $(BDIR)/segmentvol
...
$(BDIR)/volmaxima:	$(CDIR)/volmaxima.c $(IDIR)/mcimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfahsalembier.h $(IDIR)/mccodimage.h $(IDIR)/lattribvol.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribvol.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/volmaxima.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribvol.o $(LIBS) -o $(BDIR)/volmaxima

$(BDIR)/volselnb:	$(CDIR)/volselnb.c $(IDIR)/mcimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfahsalembier.h $(IDIR)/mccodimage.h $(IDIR)/lattribvol.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribvol.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/volselnb.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/lattribvol.o $(LIBS) -o $(BDIR)/volselnb

$(BDIR)/watershed:	$(CDIR)/watershed.c $(IDIR)/mcimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfahsalembier.h $(IDIR)/mccodimage.h $(IDIR)/mccomptree.h $(IDIR)/lwshedtopo.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/mccomptree.o $(ODIR)/mcunionfind.o $(ODIR)/lwshedtopo.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/watershed.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/mccomptree.o $(ODIR)/mcunionfind.o $(ODIR)/lwshedtopo.o $(LIBS) -o $(BDIR)/watershed

$(BDIR)/watershedMeyer:	$(CDIR)/watershedMeyer.c $(IDIR)/mcimage.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mccodimage.h $(IDIR)/llpemeyer.h $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccodimage.o $(ODIR)/llpemeyer.o $(ODIR)/mckhalimsky2d.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/watershedMeyer.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccodimage.o $(ODIR)/llpemeyer.o $(ODIR)/mckhalimsky2d.o $(LIBS) -o $(BDIR)/watershedMeyer

$(BDIR)/saliency:	$(CDIR)/saliency.c $(IDIR)/mcimage.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mccodimage.h $(IDIR)/llpemeyer.h $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccodimage.o $(ODIR)/llpemeyer.o $(ODIR)/mckhalimsky2d.o $(ODIR)/lsaliency.o $(ODIR)/llabelextrema.o
...
$(BDIR)/MSF:	$(CDIR)/MSF.c $(ODIR)/mcimage.o $(ODIR)/jcimage.o $(ODIR)/jclabelextrema.o $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/mcfah.o $(ODIR)/mcindic.o $(ODIR)/mcrbt.o  $(ODIR)/mclifo.o $(ODIR)/lMSF.o 
...
$(BDIR)/MSF4d:	$(CDIR)/MSF4d.c $(ODIR)/mcimage.o $(ODIR)/jcimage.o $(ODIR)/jclabelextrema.o $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/mcfah.o $(ODIR)/mcindic.o $(ODIR)/mcrbt.o  $(ODIR)/mclifo.o $(ODIR)/lMSF.o 
...
$(BDIR)/watershedMeyer4D:	$(CDIR)/watershedMeyer4D.c $(ODIR)/mcimage.o $(ODIR)/jcimage.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/llpemeyer4d.o  
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/watershedMeyer4D.c $(ODIR)/mcimage.o $(ODIR)/jcimage.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/llpemeyer4d.o  $(LIBS) -o $(BDIR)/watershedMeyer4D

$(BDIR)/watershedthin:	$(CDIR)/watershedthin.c $(IDIR)/mcimage.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mccodimage.h $(IDIR)/llpemeyer.h $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccodimage.o $(ODIR)/llpemeyer.o $(ODIR)/mckhalimsky2d.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/watershedthin.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccodimage.o $(ODIR)/llpemeyer.o $(ODIR)/mckhalimsky2d.o $(LIBS) -o $(BDIR)/watershedthin

$(BDIR)/watershedwithoutline:	$(CDIR)/watershedwithoutline.c $(IDIR)/mcimage.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mccodimage.h $(IDIR)/llpemeyer.h $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccodimage.o $(ODIR)/llpemeyer.o $(ODIR)/mckhalimsky2d.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/watershedwithoutline.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccodimage.o $(ODIR)/llpemeyer.o $(ODIR)/mckhalimsky2d.o $(LIBS) -o $(BDIR)/watershedwithoutline

$(BDIR)/watershedMeyer2:	$(CDIR)/watershedMeyer2.c $(IDIR)/mcimage.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mccodimage.h $(IDIR)/llpemeyer.h $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccodimage.o $(ODIR)/llpemeyer.o $(ODIR)/mckhalimsky2d.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/watershedMeyer2.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccodimage.o $(ODIR)/llpemeyer.o $(ODIR)/mckhalimsky2d.o $(LIBS) -o $(BDIR)/watershedMeyer2
...
$(BDIR)/wshedkhalimsky:	$(CDIR)/wshedkhalimsky.c $(ODIR)/mcfah.o $(IDIR)/mcimage.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mccodimage.h $(IDIR)/llpemeyer.h $(IDIR)/mckhalimsky2d.h $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mccodimage.o $(ODIR)/llpemeyer.o $(ODIR)/mckhalimsky2d.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/wshedkhalimsky.c $(ODIR)/mcfah.o $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mccodimage.o $(ODIR)/llpemeyer.o $(ODIR)/mckhalimsky2d.o $(LIBS) -o $(BDIR)/wshedkhalimsky

$(BDIR)/wshedval:	$(CDIR)/wshedval.c $(IDIR)/mcimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfahsalembier.h $(IDIR)/mccodimage.h $(IDIR)/ldynamique_grimaud.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/ldynamique_grimaud.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/wshedval.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahsalembier.o $(ODIR)/mccodimage.o $(ODIR)/ldynamique_grimaud.o $(LIBS) -o $(BDIR)/wshedval
...
$(BDIR)/crestheight:	$(CDIR)/crestheight.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lgeodesic.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/lhtkern.o $(ODIR)/lgeodesic.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/crestheight.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/lhtkern.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/lgeodesic.o $(LIBS) -o $(BDIR)/crestheight

$(BDIR)/crestrestoration:	$(CDIR)/crestrestoration.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/mcfah.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/lhtkern.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/crestrestoration.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/lhtkern.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/crestrestoration

$(BDIR)/crestsegment:	$(CDIR)/crestsegment.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lgeodesic.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/lhtkern.o $(ODIR)/lgeodesic.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/crestsegment.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/lhtkern.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/lgeodesic.o $(LIBS) -o $(BDIR)/crestsegment

$(BDIR)/crestvol:	$(CDIR)/crestvol.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lgeodesic.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/lhtkern.o $(ODIR)/lgeodesic.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/crestvol.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/lhtkern.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/lgeodesic.o $(LIBS) -o $(BDIR)/crestvol

$(BDIR)/deletepeaks:	$(CDIR)/deletepeaks.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mctopo3d.h $(IDIR)/lfiltrestopo.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mcindic.o $(ODIR)/llabelextrema.o $(ODIR)/llambdakern.o $(ODIR)/lfiltrestopo.o $(ODIR)/lhtkern.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/deletepeaks.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mcindic.o $(ODIR)/llabelextrema.o $(ODIR)/llambdakern.o $(ODIR)/lfiltrestopo.o $(ODIR)/lhtkern.o $(LIBS) -o $(BDIR)/deletepeaks

$(BDIR)/deletewells:	$(CDIR)/deletewells.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mctopo3d.h $(IDIR)/lfiltrestopo.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mcindic.o $(ODIR)/llabelextrema.o $(ODIR)/llambdakern.o $(ODIR)/lfiltrestopo.o $(ODIR)/lhtkern.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/deletewells.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mcindic.o $(ODIR)/llabelextrema.o $(ODIR)/llambdakern.o $(ODIR)/lfiltrestopo.o $(ODIR)/lhtkern.o $(LIBS) -o $(BDIR)/deletewells
...
$(BDIR)/grayskel:	$(CDIR)/grayskel.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/llambdakern.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahpure.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/llambdalevkern.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/grayskel.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/llambdalevkern.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahpure.o $(LIBS) -o $(BDIR)/grayskel
...
$(BDIR)/hthick:	$(CDIR)/hthick.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mctopo3d.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/mcfah.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/hthick.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/hthick
...
$(BDIR)/hthin:	$(CDIR)/hthin.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mctopo3d.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/mcfah.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/hthin.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/hthin
...
$(BDIR)/htkern:	$(CDIR)/htkern.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/htkern.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o  $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/htkern

$(BDIR)/htkern3dbin:	$(CDIR)/htkern3dbin.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo3d.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo3d.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/lhtkern3d.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/htkern3dbin.c $(OBJ_COMMON) $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/lhtkern3d.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/htkern3dbin

$(BDIR)/htkernu:	$(CDIR)/htkernu.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/htkernu.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o  $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/htkernu
...
$(BDIR)/htkernu3d:	$(CDIR)/htkernu3d.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo3d.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo3d.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/lhtkern3d.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/htkernu3d.c $(OBJ_COMMON) $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/lhtkern3d.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/htkernu3d

$(BDIR)/holeclosing:	$(CDIR)/holeclosing.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo3d.h $(IDIR)/mcfahpure.h $(IDIR)/mcindic.h $(IDIR)/ldist.h $(IDIR)/llabelextrema.h $(IDIR)/lfermetrous3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(ODIR)/mcfahpure.o $(ODIR)/ldist.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/lfermetrous3d.o $(ODIR)/lcrop.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/holeclosing.c $(OBJ_COMMON) $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/ldist.o $(ODIR)/lfermetrous3d.o $(ODIR)/mclifo.o $(ODIR)/mcfahpure.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/lcrop.o  $(LIBS) -o $(BDIR)/holeclosing
...
$(BDIR)/lambdalthin:	$(CDIR)/lambdalthin.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/llambdakern.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahpure.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/llambdalevkern.o 
	$(CC) $(CCFLAGS) -DNIVEL -I$(IDIR) $(CDIR)/lambdalthin.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/llambdalevkern.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahpure.o $(LIBS) -o $(BDIR)/lambdalthin

$(BDIR)/lambdathin:	$(CDIR)/lambdathin.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/llambdakern.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahpure.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/llambdalevkern.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/lambdathin.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/llambdalevkern.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahpure.o $(LIBS) -o $(BDIR)/lambdathin

$(BDIR)/lambdaskel:	$(CDIR)/lambdaskel.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/llambdakern.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahpure.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/llambdalevkern.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/lambdaskel.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/llambdalevkern.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfahpure.o $(LIBS) -o $(BDIR)/lambdaskel

$(BDIR)/kern:	$(CDIR)/kern.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mcfahpure.h $(IDIR)/llabelextrema.h $(IDIR)/mclifo.h $(IDIR)/lkern.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcindic.o $(ODIR)/mcfahpure.o $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(ODIR)/lkern.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/kern.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/lkern.o $(ODIR)/mcindic.o $(ODIR)/mcfahpure.o $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/kern

$(BDIR)/lpetopo:	$(CDIR)/lpetopo.c $(IDIR)/mcimage.h $(IDIR)/llabelextrema.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mccbt.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/llpetopo.h $(OBJ_COMMON) $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/llpetopo.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/lpetopo.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/llpetopo.o $(LIBS) -o $(BDIR)/lpetopo

$(BDIR)/lpetoporeg:	$(CDIR)/lpetoporeg.c $(IDIR)/mcimage.h $(IDIR)/llabelextrema.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mccbt.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/llpetoporeg.h $(OBJ_COMMON) $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/llpetoporeg.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/lpetoporeg.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mccbt.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/llpetoporeg.o $(LIBS) -o $(BDIR)/lpetoporeg

$(BDIR)/lthin:	$(CDIR)/lthin.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mctopo3d.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/mcfah.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/lthin.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/lthin

$(BDIR)/lthick:	$(CDIR)/lthick.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mctopo3d.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/mcfah.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/lthick.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/lthick

$(BDIR)/lvkern:	$(CDIR)/lvkern.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/lvkern.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o  $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/lvkern

$(BDIR)/lvkernu:	$(CDIR)/lvkernu.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/lvkernu.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o  $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/lvkernu
...
$(BDIR)/pgm2skel:	$(CDIR)/pgm2skel.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lskelcurv.h $(IDIR)/lseltopo.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcskelcurv.o $(ODIR)/mclifo.o $(ODIR)/lskelcurv.o $(ODIR)/llabelextrema.o $(ODIR)/lseltopo.o  $(ODIR)/bdd1.alphacube.o $(ODIR)/bdd2.alpha.o $(ODIR)/bdd2.beta.o $(ODIR)/bdd3.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/pgm2skel.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcskelcurv.o $(ODIR)/mclifo.o $(ODIR)/mccodimage.o $(ODIR)/lseltopo.o $(ODIR)/llabelextrema.o $(ODIR)/lskelcurv.o $(ODIR)/mckhalimsky3d.o $(ODIR)/bdd1.alphacube.o $(ODIR)/bdd2.alpha.o $(ODIR)/bdd2.beta.o $(ODIR)/bdd3.o $(LIBS) -o $(BDIR)/pgm2skel

$(BDIR)/pgm2vskel:	$(CDIR)/pgm2vskel.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lskelcurv.h $(IDIR)/lseltopo.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcskelcurv.o $(ODIR)/mclifo.o $(ODIR)/lskelcurv.o $(ODIR)/llabelextrema.o $(ODIR)/lseltopo.o $(ODIR)/bdd1.alphacube.o $(ODIR)/bdd2.alpha.o $(ODIR)/bdd2.beta.o $(ODIR)/bdd3.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/pgm2vskel.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcskelcurv.o $(ODIR)/mclifo.o $(ODIR)/mccodimage.o $(ODIR)/lseltopo.o $(ODIR)/llabelextrema.o $(ODIR)/lskelcurv.o $(ODIR)/mckhalimsky3d.o $(ODIR)/bdd1.alphacube.o $(ODIR)/bdd2.alpha.o $(ODIR)/bdd2.beta.o $(ODIR)/bdd3.o $(LIBS) -o $(BDIR)/pgm2vskel
...
$(BDIR)/ptextensible:	$(CDIR)/ptextensible.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/mcfah.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/lhtkern.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/ptextensible.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/lhtkern.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/ptextensible
...
$(BDIR)/skel2pov:	$(CDIR)/skel2pov.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lskelcurv.h $(IDIR)/lseltopo.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcskelcurv.o $(ODIR)/mclifo.o $(ODIR)/lskelcurv.o $(ODIR)/llabelextrema.o $(ODIR)/lseltopo.o $(ODIR)/bdd1.alphacube.o $(ODIR)/bdd2.alpha.o $(ODIR)/bdd2.beta.o $(ODIR)/bdd3.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/skel2pov.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcskelcurv.o $(ODIR)/mclifo.o $(ODIR)/mccodimage.o $(ODIR)/lseltopo.o $(ODIR)/llabelextrema.o $(ODIR)/lskelcurv.o $(ODIR)/mckhalimsky3d.o $(ODIR)/bdd1.alphacube.o $(ODIR)/bdd2.alpha.o $(ODIR)/bdd2.beta.o $(ODIR)/bdd3.o $(LIBS) -o $(BDIR)/skel2pov
...
$(BDIR)/skelpar:	$(CDIR)/skelpar.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/lskelpar.h $(IDIR)/ldist.h $(IDIR)/mcgeo.h $(IDIR)/lmedialaxis.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcindic.o $(ODIR)/mcrbt.o $(ODIR)/mcgeo.o $(ODIR)/ldist.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ltopotypes.o $(ODIR)/lskelpar.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/skelpar.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/lskelpar.o $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/mcrbt.o $(ODIR)/mcgeo.o $(ODIR)/ldist.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ltopotypes.o $(LIBS) -o $(BDIR)/skelpar

$(BDIR)/skelpar3d:	$(CDIR)/skelpar3d.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/lskelpar3d.h $(IDIR)/ldist.h $(IDIR)/mcgeo.h $(IDIR)/lmedialaxis.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcindic.o $(ODIR)/mcrbt.o $(ODIR)/mcgeo.o $(ODIR)/ldist.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ltopotypes.o $(ODIR)/lskelpar3d.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/skelpar3d.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/lskelpar3d.o $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/mcrbt.o $(ODIR)/mcgeo.o $(ODIR)/ldist.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ltopotypes.o $(LIBS) -o $(BDIR)/skelpar3d
...
$(BDIR)/bisector:	$(CDIR)/bisector.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/lskeletons.h $(IDIR)/mcgeo.h $(IDIR)/ldist.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcindic.o $(ODIR)/mcrbt.o $(ODIR)/mcgeo.o $(ODIR)/lskeletons.o $(ODIR)/ldist.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ltopotypes.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/bisector.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/lskeletons.o $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/mcrbt.o $(ODIR)/mcgeo.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(LIBS) -o $(BDIR)/bisector

$(BDIR)/bisector_talbot:	$(CDIR)/bisector_talbot.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/lskeletons.h $(IDIR)/mcgeo.h $(IDIR)/ldist.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcindic.o $(ODIR)/mcrbt.o $(ODIR)/mcgeo.o $(ODIR)/lskeletons.o $(ODIR)/ldist.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ltopotypes.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/bisector_talbot.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/lskeletons.o $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/mcrbt.o $(ODIR)/mcgeo.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(LIBS) -o $(BDIR)/bisector_talbot
...
$(BDIR)/surfacerestoration:	$(CDIR)/surfacerestoration.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo3d.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/mcfah.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo3d.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/lhtkern3d.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/surfacerestoration.c $(OBJ_COMMON) $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/lhtkern3d.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/surfacerestoration
...
$(BDIR)/taf:	$(CDIR)/taf.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mctopo.h $(IDIR)/mctopo3d.h $(IDIR)/lfiltrestopo.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mcindic.o $(ODIR)/lfiltrestopo.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o $(ODIR)/llabelextrema.o $(ODIR)/llambdakern.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/taf.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mcindic.o $(ODIR)/llabelextrema.o $(ODIR)/llambdakern.o $(ODIR)/lfiltrestopo.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o $(LIBS) -o $(BDIR)/taf

$(BDIR)/tlf:	$(CDIR)/tlf.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mctopo.h $(IDIR)/mctopo3d.h $(IDIR)/lfiltrestopo.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mcindic.o $(ODIR)/lfiltrestopo.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o $(ODIR)/llabelextrema.o $(ODIR)/llambdakern.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/tlf.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mcindic.o $(ODIR)/lfiltrestopo.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o $(ODIR)/llabelextrema.o $(ODIR)/llambdakern.o $(LIBS) -o $(BDIR)/tlf

$(BDIR)/tuf:	$(CDIR)/tuf.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mctopo.h $(IDIR)/mctopo3d.h $(IDIR)/lfiltrestopo.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mcindic.o $(ODIR)/lfiltrestopo.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o $(ODIR)/llabelextrema.o $(ODIR)/llambdakern.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/tuf.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mcindic.o $(ODIR)/lfiltrestopo.o $(ODIR)/lhtkern.o $(ODIR)/lhtkern3d.o $(ODIR)/llabelextrema.o $(ODIR)/llambdakern.o $(LIBS) -o $(BDIR)/tuf
...
$(BDIR)/toposhrinkgray:	$(CDIR)/toposhrinkgray.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcfah.h $(IDIR)/mcindic.h $(IDIR)/lskeletons.h $(IDIR)/ldist.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcindic.o $(ODIR)/mcrbt.o $(ODIR)/mcgeo.o $(ODIR)/ldist.o $(ODIR)/lskeletons.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/toposhrinkgray.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/lskeletons.o $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfifo.o $(ODIR)/mcfah.o $(ODIR)/mcrbt.o $(ODIR)/mcgeo.o $(ODIR)/ldist.o $(LIBS) -o $(BDIR)/toposhrinkgray
...
$(BDIR)/boxmin:	$(CDIR)/boxmin.c $(IDIR)/mcimage.h $(IDIR)/lgeo.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcgeo.o $(ODIR)/mcliste.o $(ODIR)/lbresen.o $(ODIR)/llabelextrema.o $(ODIR)/lgeo.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/boxmin.c $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcgeo.o $(ODIR)/mcliste.o $(ODIR)/lbresen.o $(ODIR)/llabelextrema.o $(ODIR)/lgeo.o $(LIBS) -o $(BDIR)/boxmin
...
$(BDIR)/fitcircle:	$(CDIR)/fitcircle.c $(IDIR)/lgeo.h $(IDIR)/mcimage.h $(IDIR)/mclin.h $(IDIR)/lbresen.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mcgeo.o $(ODIR)/mctopo.o $(ODIR)/lgeo.o $(ODIR)/lbresen.o $(ODIR)/mclifo.o $(ODIR)/mcliste.o $(ODIR)/llabelextrema.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/fitcircle.c $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mcgeo.o $(ODIR)/lbresen.o $(ODIR)/mclifo.o $(ODIR)/mcliste.o $(ODIR)/lgeo.o $(ODIR)/llabelextrema.o $(ODIR)/mctopo.o $(LIBS) -o $(BDIR)/fitcircle
...
$(BDIR)/egalise:	$(CDIR)/egalise.c $(IDIR)/legalise.h $(IDIR)/mcfah.h $(IDIR)/mcimage.h $(ODIR)/legalise.o $(ODIR)/mcfah.o $(OBJ_COMMON)
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/egalise.c $(ODIR)/legalise.o $(ODIR)/mcfah.o $(OBJ_COMMON) $(LIBS) -o $(BDIR)/egalise
...
$(BDIR)/histscal:	$(CDIR)/histscal.c $(IDIR)/lhistscal.h $(IDIR)/mcfah.h $(IDIR)/mcimage.h $(ODIR)/lhistscal.o $(ODIR)/mcfah.o $(OBJ_COMMON)
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/histscal.c $(ODIR)/lhistscal.o $(ODIR)/mcfah.o $(OBJ_COMMON) $(LIBS) -o $(BDIR)/histscal

$(BDIR)/histstretch:	$(CDIR)/histstretch.c $(IDIR)/lhistscal.h $(IDIR)/mcfah.h $(IDIR)/mcimage.h $(ODIR)/lhistscal.o $(ODIR)/mcfah.o $(OBJ_COMMON)
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/histstretch.c $(ODIR)/lhistscal.o $(ODIR)/mcfah.o $(OBJ_COMMON) $(LIBS) -o $(BDIR)/histstretch
...
$(BDIR)/mcube:	$(CDIR)/mcube.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mcgeo.h $(IDIR)/mcmesh.h $(IDIR)/mciomesh.h $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(IDIR)/mcrbt1.h $(ODIR)/mcrbt1.o $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mcgeo.o $(ODIR)/mcprobas.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/mcube.c $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(ODIR)/mcrbt1.o $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mcgeo.o $(ODIR)/mcprobas.o $(LIBS) -o $(BDIR)/mcube

$(BDIR)/meshaddnoise:	$(CDIR)/meshaddnoise.c $(IDIR)/mcmesh.h $(IDIR)/mciomesh.h $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(ODIR)/mcprobas.o
	$(CC) $(CCFLAGS) -I$(IDIR) -I. $(CDIR)/meshaddnoise.c $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(ODIR)/mcrbt1.o $(ODIR)/mcgeo.o $(ODIR)/mcprobas.o $(LIBS) -o $(BDIR)/meshaddnoise

$(BDIR)/meshconvert:	$(CDIR)/meshconvert.c $(IDIR)/mcmesh.h $(IDIR)/mciomesh.h $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(ODIR)/mcprobas.o $(OBJ_COMMON)
			$(CC) $(CCFLAGS) -I$(IDIR) -I. $(CDIR)/meshconvert.c $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(ODIR)/mcrbt1.o $(ODIR)/mcgeo.o $(ODIR)/mcprobas.o  $(OBJ_COMMON) $(LIBS) -o $(BDIR)/meshconvert

$(BDIR)/meshregul:	$(CDIR)/meshregul.c $(IDIR)/mcmesh.h $(IDIR)/mciomesh.h $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(ODIR)/mcprobas.o
	$(CC) $(CCFLAGS) -I$(IDIR) -I. $(CDIR)/meshregul.c $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(ODIR)/mcrbt1.o $(ODIR)/mcgeo.o $(ODIR)/mcprobas.o $(LIBS) -o $(BDIR)/meshregul

$(BDIR)/mcm2ac:	$(CDIR)/mcm2ac.c $(IDIR)/mcmesh.h $(IDIR)/mciomesh.h $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(ODIR)/mcprobas.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/mcm2ac.c $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(ODIR)/mcrbt1.o $(ODIR)/mcgeo.o $(ODIR)/mcprobas.o $(LIBS) -o $(BDIR)/mcm2ac

$(BDIR)/mcm2vtk:	$(CDIR)/mcm2vtk.c $(IDIR)/mcmesh.h $(IDIR)/mciomesh.h $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(ODIR)/mcprobas.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/mcm2vtk.c $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(ODIR)/mcrbt1.o $(ODIR)/mcgeo.o $(ODIR)/mcprobas.o $(LIBS) -o $(BDIR)/mcm2vtk

$(BDIR)/mcmbuild:	$(CDIR)/mcmbuild.c $(IDIR)/mcmesh.h $(IDIR)/mciomesh.h $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(ODIR)/mcprobas.o
	$(CC) $(CCFLAGS) -I$(IDIR) -I. $(CDIR)/mcmbuild.c $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(ODIR)/mcrbt1.o $(ODIR)/mcgeo.o $(ODIR)/mcprobas.o $(LIBS) -o $(BDIR)/mcmbuild

$(BDIR)/surfels:	$(CDIR)/surfels.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mcgeo.h $(IDIR)/mcmesh.h $(IDIR)/mciomesh.h $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(IDIR)/mcrbt1.h $(ODIR)/mcrbt1.o $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mcgeo.o $(ODIR)/mcprobas.o
	$(CC) $(CCFLAGS) -I$(IDIR) -I. $(CDIR)/surfels.c $(ODIR)/mcmesh.o $(ODIR)/mciomesh.o $(ODIR)/mcrbt1.o $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mcgeo.o $(ODIR)/mcprobas.o $(LIBS) -o $(BDIR)/surfels
...
$(BDIR)/contours:	$(CDIR)/contours.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/llabelextrema.h $(IDIR)/lcontours.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/llabelextrema.o $(ODIR)/lcontours.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/contours.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/lcontours.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/contours
...
$(BDIR)/dynrecons:	$(CDIR)/dynrecons.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(ODIR)/lhisto.o $(ODIR)/llabelextrema.o $(ODIR)/lhtkern.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/dynrecons.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/lhisto.o $(ODIR)/lhtkern.o $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/dynrecons

$(BDIR)/fusreg:	$(CDIR)/fusreg.c $(IDIR)/lfusreg.h $(IDIR)/mcfahdouble.h $(IDIR)/mcfusion.h $(IDIR)/mcgraphe.h $(IDIR)/mcimage.h $(IDIR)/mcindic.h $(IDIR)/mccodimage.h $(ODIR)/lfusreg.o $(ODIR)/mcfahdouble.o $(ODIR)/mcfusion.o $(ODIR)/mcgraphe.o $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mccodimage.o $(ODIR)/mcsort.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/fusreg.c $(ODIR)/lfusreg.o $(ODIR)/mcfahdouble.o $(ODIR)/mcfusion.o $(ODIR)/mcgraphe.o $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mcsort.o $(ODIR)/mcindic.o $(LIBS) -o $(BDIR)/fusreg

$(BDIR)/jones:	$(CDIR)/jones.c $(IDIR)/mcimage.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mctree.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/ljones.h $(OBJ_COMMON) $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mctree.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/ljones.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/jones.c $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mctree.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/ljones.o $(LIBS) -o $(BDIR)/jones
...
$(BDIR)/recons:	$(CDIR)/recons.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mclifo.h $(IDIR)/mcfahdouble.h $(IDIR)/llabelextrema.h $(IDIR)/lfusreg.h $(IDIR)/lpropgeo.h $(IDIR)/lrecons.h $(OBJ_COMMON) $(ODIR)/llabelextrema.o $(ODIR)/lfusreg.o $(ODIR)/lpropgeo.o $(ODIR)/lrecons.o $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/mcfahdouble.o $(ODIR)/mcfusion.o $(ODIR)/mcgraphe.o $(ODIR)/mcsort.o $(ODIR)/mcindic.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/recons.c $(OBJ_COMMON) $(ODIR)/llabelextrema.o $(ODIR)/lfusreg.o $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/mcfahdouble.o $(ODIR)/mcfusion.o $(ODIR)/mcgraphe.o $(ODIR)/mcsort.o $(ODIR)/lpropgeo.o $(ODIR)/mcprobas.o $(ODIR)/lrecons.o $(ODIR)/mcindic.o $(LIBS) -o $(BDIR)/recons
...
$(BDIR)/regul:	$(CDIR)/regul.c $(IDIR)/lregul.h $(IDIR)/llvkern.h $(IDIR)/mcimage.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/mccodimage.h $(ODIR)/lregul.o $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/llvkern.o $(ODIR)/mcfifo.o $(ODIR)/llabelextrema.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/regul.c $(ODIR)/lregul.o $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcfah.o $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/llvkern.o $(ODIR)/mcfifo.o $(ODIR)/llabelextrema.o $(LIBS) -o $(BDIR)/regul
...
$(BDIR)/segbi:	$(CDIR)/segbi.c $(IDIR)/mctopo.h $(IDIR)/mcimage.h $(IDIR)/llabelextrema.h $(IDIR)/mclifo.h $(IDIR)/mcindic.h $(IDIR)/mcfahpure.h $(IDIR)/mccodimage.h $(IDIR)/lsegbi.h $(ODIR)/mctopo.o $(OBJ_COMMON) $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcfahpure.o $(ODIR)/mccodimage.o $(ODIR)/lsegbi.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/segbi.c $(ODIR)/mctopo.o $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/llabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcfahpure.o $(ODIR)/mccodimage.o $(ODIR)/lsegbi.o $(LIBS) -o $(BDIR)/segbi

$(BDIR)/segmentlignes:	$(CDIR)/segmentlignes.c $(IDIR)/mclifo.h $(IDIR)/mcimage.h $(IDIR)/llabelextrema.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/lsegmentlignes.h $(ODIR)/mclifo.o $(OBJ_COMMON) $(ODIR)/llabelextrema.o $(ODIR)/mcindic.o $(ODIR)/mcfah.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/lsegmentlignes.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/segmentlignes.c $(ODIR)/mclifo.o $(OBJ_COMMON) $(ODIR)/mcindic.o $(ODIR)/llabelextrema.o $(ODIR)/mcfah.o $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/lsegmentlignes.o $(LIBS) -o $(BDIR)/segmentlignes
...
$(ODIR)/lattribarea.o:	$(LDIR)/lattribarea.c $(LDIR)/lattrib.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mclifo.h $(IDIR)/mcfahsalembier.h
	$(CC) -c $(CCFLAGS) -I$(IDIR) $(LDIR)/lattribarea.c -o $(ODIR)/lattribarea.o

$(ODIR)/lattribheight.o:	$(LDIR)/lattribheight.c $(LDIR)/lattrib.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mclifo.h $(IDIR)/mcfahsalembier.h
	$(CC) -c $(CCFLAGS) -I$(IDIR) $(LDIR)/lattribheight.c -o $(ODIR)/lattribheight.o

$(ODIR)/lattribvol.o:	$(LDIR)/lattribvol.c $(LDIR)/lattrib.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mclifo.h $(IDIR)/mcfahsalembier.h
	$(CC) -c $(CCFLAGS) -I$(IDIR) $(LDIR)/lattribvol.c -o $(ODIR)/lattribvol.o

$(ODIR)/ldynamique.o:	$(LDIR)/ldynamique.c $(LDIR)/lattrib.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mclifo.h $(IDIR)/mcfahsalembier.h
	$(CC) -c $(CCFLAGS) -I$(IDIR) $(LDIR)/ldynamique.c -o $(ODIR)/ldynamique.o

$(ODIR)/ldynamique_grimaud.o:	$(LDIR)/ldynamique_grimaud.c $(LDIR)/lattrib.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mclifo.h $(IDIR)/mcfahsalembier.h
...
$(ODIR)/lreconsdilat3d.o:	$(LDIR)/lreconsdilat3d.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mcfifo.h $(IDIR)/mcindic.h $(IDIR)/lreconsdilat3d.h
	$(CC) -c $(CCFLAGS) -I$(IDIR) $(LDIR)/lreconsdilat3d.c -o $(ODIR)/lreconsdilat3d.o

$(ODIR)/lreconseros3d.o:	$(LDIR)/lreconseros3d.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mcfifo.h $(IDIR)/mcindic.h $(IDIR)/lreconseros3d.h
	$(CC) -c $(CCFLAGS) -I$(IDIR) $(LDIR)/lreconseros3d.c -o $(ODIR)/lreconseros3d.o

$(ODIR)/lsegreconsheight.o:	$(LDIR)/lsegreconsheight.c $(LDIR)/lattrib.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mclifo.h $(IDIR)/mcfahsalembier.h
...
$(ODIR)/llvkern.o:	$(LDIR)/llvkern.c $(IDIR)/mccodimage.h $(IDIR)/mcfifo.h $(IDIR)/mcfah.h $(IDIR)/mctopo.h
	$(CC) -c $(CCFLAGS) -I$(IDIR) $(LDIR)/llvkern.c -o $(ODIR)/llvkern.o
...
$(ODIR)/l3dcollapse.o:	$(LDIR)/l3dcollapse.c $(IDIR)/mccodimage.h $(IDIR)/mckhalimsky3d.h $(IDIR)/l3dcollapse.h
...
$(ODIR)/lfusreg.o:	$(LDIR)/lfusreg.c $(IDIR)/mcgraphe.h $(IDIR)/mcfusion.h $(IDIR)/mccodimage.h $(IDIR)/mcutil.h $(IDIR)/mcfahdouble.h
	$(CC) -c $(CCFLAGS) -I$(IDIR) $(LDIR)/lfusreg.c -o $(ODIR)/lfusreg.o
...
$(ODIR)/lrecons.o:	$(LDIR)/lrecons.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mclifo.h $(IDIR)/mcfah.h $(IDIR)/llabelextrema.h $(IDIR)/lfusreg.h $(IDIR)/lpropgeo.h $(IDIR)/lrecons.h
	$(CC) -c $(CCFLAGS) -I$(IDIR) $(LDIR)/lrecons.c -o $(ODIR)/lrecons.o
...
$(ODIR)/mcfahdouble.o:	$(LDIR)/mcfahdouble.c $(IDIR)/mccodimage.h $(IDIR)/mcfahdouble.h
	$(CC) -c $(CCFLAGS) -I$(IDIR) $(LDIR)/mcfahdouble.c -o $(ODIR)/mcfahdouble.o
...
$(ODIR)/mcgraphe.o:	$(LDIR)/mcgraphe.c $(IDIR)/mcgraphe.h $(IDIR)/mcsort.h
