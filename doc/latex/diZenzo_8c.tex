...
diZenzo gradient pour les images couleurs {\bfseries Usage:} diZenzo imageRVB.ppm alpha [mode] out.pgm

{\bfseries Description:} Le gradient de diZenzo est défini par la donnée de p, q, et t:
...
La direction est donnée par 1/2$\ast$atan(2$\ast$t/(p-\/q))

Si le mode est égale à 0 (valeur défaut) alors l'image de sortie est le gradient, sinon l'image de sortie est une int32\_\-t entre 0 et 360.
