...
{\bf Description:} A weighted graph G = (V,E) is defined with V = set of pixels of {\bf in.pgm} and E = \{(P,Q) in VxV ; P and Q are {\bf connex-} adjacent\}. Let F(P) be the value of pixel P in the image {\bf in.pgm}. A weight W(P,Q) is assigned to each edge, according to the value of {\bf mode:} 
