...
all:	$(ODIR)/libpink.a $(OBJ) $(ARITH) $(CONVERT) $(MORPHO) $(CONNECT) $(GA) $(TOPO) $(ORDRES) $(DRAW) $(GEO) $(HISTO) $(SIGNAL) $(DIVERS) $(MESH3D) $(ANDRE) doc
...
$(BDIR)/seuilauto:	$(CDIR)/seuilauto.c $(IDIR)/mcimage.h $(IDIR)/lseuil.h $(IDIR)/lhisto.h $(OBJ_COMMON) $(ODIR)/libpink.a
...
$(BDIR)/double2byte:	$(CDIR)/double2byte.c $(IDIR)/mcimage.h $(IDIR)/lhisto.h $(OBJ_COMMON) $(ODIR)/libpink.a
...
$(BDIR)/float2byte:	$(CDIR)/float2byte.c $(IDIR)/mcimage.h $(IDIR)/lhisto.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/float2byte.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/float2byte

$(BDIR)/float2long:	$(CDIR)/float2long.c $(IDIR)/mcimage.h $(IDIR)/lhisto.h $(OBJ_COMMON) $(ODIR)/libpink.a
...
$(BDIR)/long2byte:	$(CDIR)/long2byte.c $(IDIR)/mcimage.h $(IDIR)/lhisto.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/long2byte.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/long2byte

$(BDIR)/long2float:	$(CDIR)/long2float.c $(IDIR)/mcimage.h $(IDIR)/lhisto.h $(OBJ_COMMON) $(ODIR)/libpink.a
...
$(BDIR)/lambdamedialaxisauto:	$(CDIR)/lambdamedialaxisauto.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lmedialaxis.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/lballincl.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/lambdamedialaxisauto.c $(ODIR)/mccodimage.o $(OBJ_COMMON) $(ODIR)/lballincl.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/lambdamedialaxisauto
...
$(BDIR)/lambdamedialaxis2auto:	$(CDIR)/lambdamedialaxis2auto.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lmedialaxis.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/lballincl.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/lambdamedialaxis2auto.c $(ODIR)/mccodimage.o $(OBJ_COMMON) $(ODIR)/lballincl.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/lambdamedialaxis2auto
...
$(BDIR)/scaleaxis:	$(CDIR)/scaleaxis.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lmedialaxis.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/lballincl.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/scaleaxis.c $(ODIR)/mccodimage.o $(OBJ_COMMON) $(ODIR)/lballincl.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/scaleaxis
...
$(BDIR)/scalefilteredmedialaxis:	$(CDIR)/scalefilteredmedialaxis.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lmedialaxis.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/lballincl.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/scalefilteredmedialaxis.c $(ODIR)/mccodimage.o $(OBJ_COMMON) $(ODIR)/lballincl.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/scalefilteredmedialaxis
...
$(BDIR)/sfema:	$(CDIR)/sfema.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lmedialaxis.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/lballincl.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/sfema.c $(ODIR)/mccodimage.o $(OBJ_COMMON) $(ODIR)/lballincl.o $(ODIR)/lmedialaxis.o $(ODIR)/avsimage.o $(ODIR)/llut.o $(ODIR)/ldist.o $(ODIR)/ltopotypes.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(LIBS) -o $(BDIR)/sfema
...
$(BDIR)/MSF:	$(CDIR)/MSF.c $(ODIR)/jcimage.o $(ODIR)/jclabelextrema.o $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/mcindic.o $(ODIR)/mcrbt.o $(ODIR)/mclifo.o $(ODIR)/lMSF.o $(OBJ_COMMON)
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/MSF.c $(ODIR)/llabelextrema.o $(ODIR)/jclabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcrbt.o $(ODIR)/jcimage.o $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/mcindic.o $(ODIR)/lMSF.o $(OBJ_COMMON) $(LIBS) -o $(BDIR)/MSF
...
$(BDIR)/MSF4d:	$(CDIR)/MSF4d.c $(ODIR)/jcimage.o $(ODIR)/jclabelextrema.o $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/mcindic.o $(ODIR)/mcrbt.o $(ODIR)/mclifo.o $(ODIR)/lMSF.o $(OBJ_COMMON)
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/MSF4d.c $(ODIR)/llabelextrema.o $(ODIR)/jclabelextrema.o $(ODIR)/mclifo.o $(ODIR)/mcrbt.o $(ODIR)/jcimage.o $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/mcindic.o $(ODIR)/lMSF.o $(OBJ_COMMON) $(LIBS) -o $(BDIR)/MSF4d
...
$(BDIR)/GAwatershed:	$(CDIR)/GAwatershed.c $(ODIR)/jcimage.o $(ODIR)/jclabelextrema.o $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/llpeGA.o $(ODIR)/jcgraphes.o $(ODIR)/mcfifo.o $(ODIR)/mclifo.o $(OBJ_COMMON)
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/GAwatershed.c $(ODIR)/jclabelextrema.o $(ODIR)/mclifo.o $(ODIR)/jcimage.o $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/llpeGA.o $(ODIR)/jcgraphes.o $(ODIR)/mcfifo.o $(OBJ_COMMON) $(LIBS) -o $(BDIR)/GAwatershed 
...
$(BDIR)/GAwatershedDouble:	 $(CDIR)/GAwatershedDouble.c $(ODIR)/jcimage.o $(ODIR)/jclabelextrema.o $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/llpeGA.o $(ODIR)/jcgraphes.o $(ODIR)/mcfifo.o $(ODIR)/mclifo.o $(ODIR)/lppm2GA.o $(ODIR)/lderiche.o $(OBJ_COMMON)
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/GAwatershedDouble.c $(ODIR)/jclabelextrema.o $(ODIR)/mclifo.o $(ODIR)/jcimage.o $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/llpeGA.o $(ODIR)/jcgraphes.o $(ODIR)/mcfifo.o $(ODIR)/lppm2GA.o $(ODIR)/lderiche.o $(OBJ_COMMON) $(LIBS) -o $(BDIR)/GAwatershedDouble 
...
$(BDIR)/watershedMeyer4D:	$(CDIR)/watershedMeyer4D.c $(ODIR)/jcimage.o $(ODIR)/mcindic.o $(OBJMCFAH) $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/llpemeyer4d.o $(OBJ_COMMON)
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/watershedMeyer4D.c $(ODIR)/jcimage.o $(ODIR)/mcindic.o $(OBJMCFAH) $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/llpemeyer4d.o $(OBJ_COMMON) $(LIBS) -o $(BDIR)/watershedMeyer4D
...
$(BDIR)/saliencyGA:	$(ODIR)/jcimage.o $(ODIR)/jclabelextrema.o $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/llpeGA.o $(ODIR)/jcgraphes.o $(ODIR)/lhierarchie.o $(ODIR)/mcunionfind.o $(ODIR)/jccomptree.o $(ODIR)/mcfifo.o $(ODIR)/mclifo.o $(CDIR)/saliencyGA.c $(OBJ_COMMON)
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/saliencyGA.c $(ODIR)/jclabelextrema.o $(ODIR)/jcimage.o $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/llpeGA.o $(ODIR)/jcgraphes.o $(ODIR)/lhierarchie.o $(ODIR)/mcunionfind.o $(ODIR)/jccomptree.o $(ODIR)/mcfifo.o $(ODIR)/mclifo.o $(OBJ_COMMON) $(LIBS) -o $(BDIR)/saliencyGA
...
$(BDIR)/waterfall:	$(ODIR)/jcimage.o $(ODIR)/jclabelextrema.o $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/llpeGA.o $(ODIR)/jcgraphes.o $(ODIR)/lhierarchie.o $(ODIR)/mcfifo.o $(CDIR)/waterfall.c $(ODIR)/mcunionfind.o $(ODIR)/jccomptree.o $(ODIR)/mclifo.o $(OBJ_COMMON)
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/waterfall.c $(ODIR)/jclabelextrema.o $(ODIR)/jcimage.o $(ODIR)/mccodimage.o $(ODIR)/jccodimage.o $(ODIR)/jccomptree.o $(ODIR)/mcunionfind.o $(ODIR)/llpeGA.o $(ODIR)/jcgraphes.o $(ODIR)/lhierarchie.o $(ODIR)/mcfifo.o $(ODIR)/mclifo.o $(OBJ_COMMON) $(LIBS) -o $(BDIR)/waterfall 
...
$(BDIR)/crestheight:	$(CDIR)/crestheight.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lgeodesic.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/crestheight.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/crestheight

$(BDIR)/crestrestoration:	$(CDIR)/crestrestoration.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/mcfah.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/crestrestoration.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/crestrestoration

$(BDIR)/crestsegment:	$(CDIR)/crestsegment.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lgeodesic.h $(OBJ_COMMON) $(ODIR)/libpink.a $(ODIR)/llabelextrema.o $(ODIR)/lhtkern.o $(ODIR)/lgeodesic.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/crestsegment.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/crestsegment

$(BDIR)/crestvol:	$(CDIR)/crestvol.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lgeodesic.h $(OBJ_COMMON) $(ODIR)/libpink.a $(ODIR)/llabelextrema.o $(ODIR)/lhtkern.o $(ODIR)/lgeodesic.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/crestvol.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/crestvol
...
$(BDIR)/grayskel:	$(CDIR)/grayskel.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/llambdakern.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/grayskel.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/grayskel
...
$(BDIR)/hthick:	$(CDIR)/hthick.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mctopo3d.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/mcfah.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/hthick.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/hthick
...
$(BDIR)/hthin:	$(CDIR)/hthin.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mctopo3d.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/mcfah.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/hthin.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/hthin
...
$(BDIR)/htkern3dbin:	$(CDIR)/htkern3dbin.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo3d.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/htkern3dbin.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/htkern3dbin

$(BDIR)/htkernu:	$(CDIR)/htkernu.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/htkernu.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/htkernu

$(BDIR)/htkernu3d:	$(CDIR)/htkernu3d.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo3d.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/htkernu3d.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/htkernu3d
...
$(BDIR)/lambdalthin:	$(CDIR)/lambdalthin.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/llambdakern.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -DNIVEL -I$(IDIR) $(CDIR)/lambdalthin.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/lambdalthin

$(BDIR)/lambdathin:	$(CDIR)/lambdathin.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/llambdakern.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/lambdathin.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/lambdathin

$(BDIR)/lambdaskel:	$(CDIR)/lambdaskel.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/llambdakern.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/lambdaskel.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/lambdaskel
...
$(BDIR)/lthin:	$(CDIR)/lthin.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mctopo3d.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/mcfah.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/lthin.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/lthin

$(BDIR)/lthick:	$(CDIR)/lthick.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mctopo3d.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/mcfah.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/lthick.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/lthick

$(BDIR)/lvkern:	$(CDIR)/lvkern.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mcfah.h $(IDIR)/mclifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/lvkern.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/lvkern
...
$(BDIR)/ptextensible:	$(CDIR)/ptextensible.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/mcfah.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/ptextensible.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/ptextensible
...
$(BDIR)/ptjunction:	$(CDIR)/ptjunction.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/lseltopo.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(ODIR)/lseltopo.o $(ODIR)/bdd1.alphacube.o $(ODIR)/bdd2.alpha.o $(ODIR)/bdd2.beta.o $(ODIR)/bdd3.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/ptjunction.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/lseltopo.o $(ODIR)/mckhalimsky3d.o $(ODIR)/bdd1.alphacube.o $(ODIR)/bdd2.alpha.o $(ODIR)/bdd2.beta.o $(ODIR)/bdd3.o $(LIBS) -o $(BDIR)/ptjunction
...
$(BDIR)/pthseparatinggray:	$(CDIR)/pthseparatinggray.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/lseltopo.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(ODIR)/lseltopo.o $(ODIR)/bdd1.alphacube.o $(ODIR)/bdd2.alpha.o $(ODIR)/bdd2.beta.o $(ODIR)/bdd3.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/pthseparatinggray.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/lseltopo.o $(ODIR)/mckhalimsky3d.o $(ODIR)/bdd1.alphacube.o $(ODIR)/bdd2.alpha.o $(ODIR)/bdd2.beta.o $(ODIR)/bdd3.o $(LIBS) -o $(BDIR)/pthseparatinggray
...
$(BDIR)/ptthickend:	$(CDIR)/ptthickend.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/lseltopo.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(ODIR)/lseltopo.o $(ODIR)/bdd1.alphacube.o $(ODIR)/bdd2.alpha.o $(ODIR)/bdd2.beta.o $(ODIR)/bdd3.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/ptthickend.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(ODIR)/mccodimage.o $(ODIR)/lseltopo.o $(ODIR)/mckhalimsky3d.o $(ODIR)/bdd1.alphacube.o $(ODIR)/bdd2.alpha.o $(ODIR)/bdd2.beta.o $(ODIR)/bdd3.o $(LIBS) -o $(BDIR)/ptthickend
...
$(BDIR)/ptthickisthmus:	$(CDIR)/ptthickisthmus.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/lskelpar3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mclifo.o $(ODIR)/lskelpar3d.o $(ODIR)/bdd1.alphacube.o $(ODIR)/bdd2.alpha.o $(ODIR)/bdd2.beta.o $(ODIR)/bdd3.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/ptthickisthmus.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/ptthickisthmus
...
$(BDIR)/squel:	$(CDIR)/squel.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/mcfifo.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lsquel.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/squel.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/squel
...
$(BDIR)/skel_ACK3:	$(CDIR)/skel_ACK3.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lskelpar3d.h $(IDIR)/mctopo3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcrlifo.o $(ODIR)/mctopo3d.o $(ODIR)/mctopo.o $(ODIR)/lskelpar3d.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/skel_ACK3.c $(OBJ_COMMON) $(ODIR)/mctopo3d.o $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/lskelpar3d.o $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcrlifo.o $(LIBS) -o $(BDIR)/skel_ACK3
...
$(BDIR)/skel_ASK3p:	$(CDIR)/skel_ASK3p.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lskelpar.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/mctopo.o $(ODIR)/lskelpar.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/skel_ASK3p.c $(OBJ_COMMON) $(ODIR)/libpink.a -o $(BDIR)/skel_ASK3p
...
$(BDIR)/skel_CK3a:	$(CDIR)/skel_CK3a.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lskelpar3d.h $(IDIR)/mctopo3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/mctopo3d.o $(ODIR)/mctopo.o $(ODIR)/lskelpar3d.o $(ODIR)/mcindic.o $(ODIR)/mcrlifo.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/skel_CK3a.c $(OBJ_COMMON) $(ODIR)/mctopo3d.o $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/lskelpar3d.o $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcrlifo.o $(LIBS) -o $(BDIR)/skel_CK3a
...
$(BDIR)/skel_CK3p:	$(CDIR)/skel_CK3p.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lskelpar3d.h $(IDIR)/mctopo3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/mctopo3d.o $(ODIR)/mctopo.o $(ODIR)/lskelpar3d.o $(ODIR)/mcindic.o $(ODIR)/mcrlifo.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/skel_CK3p.c $(OBJ_COMMON) $(ODIR)/mctopo3d.o $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/lskelpar3d.o $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcrlifo.o $(LIBS) -o $(BDIR)/skel_CK3p
...
$(BDIR)/skel_CKSC3:	$(CDIR)/skel_CKSC3.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lskeletons.h $(IDIR)/mctopo3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/mctopo3d.o $(ODIR)/mctopo.o $(ODIR)/lskeletons.o $(ODIR)/mcindic.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/skel_CKSC3.c $(ODIR)/libpink.a  $(LIBS) -o $(BDIR)/skel_CKSC3
...
$(BDIR)/skel_SK3:	$(CDIR)/skel_SK3.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lskelpar3d.h $(IDIR)/mctopo3d.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mclifo.o $(ODIR)/mctopo3d.o $(ODIR)/mctopo.o $(ODIR)/lskelpar3d.o $(ODIR)/mcindic.o $(ODIR)/mcrlifo.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/skel_SK3.c $(OBJ_COMMON) $(ODIR)/mctopo3d.o $(ODIR)/mctopo.o $(ODIR)/mccodimage.o $(ODIR)/lskelpar3d.o $(ODIR)/mclifo.o $(ODIR)/mcindic.o $(ODIR)/mcrlifo.o $(LIBS) -o $(BDIR)/skel_SK3
...
$(BDIR)/skelcurv:	$(CDIR)/skelcurv.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo.h $(IDIR)/mcindic.h $(IDIR)/lskeletons.h $(IDIR)/ldist.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/mcfifo.o $(ODIR)/mclifo.o $(ODIR)/mcliste.o $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mcindic.o $(ODIR)/mcrbt.o $(ODIR)/mcgeo.o $(ODIR)/ldist.o $(ODIR)/mcrlifo.o $(ODIR)/lskeletons.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/skelcurv.c $(OBJ_COMMON) $(ODIR)/mctopo.o $(ODIR)/mctopo3d.o $(ODIR)/mccodimage.o $(ODIR)/mcrlifo.o $(ODIR)/lskeletons.o $(ODIR)/mcindic.o $(ODIR)/mclifo.o $(ODIR)/mcliste.o $(ODIR)/mcfifo.o $(ODIR)/mcrbt.o $(ODIR)/mcgeo.o $(ODIR)/ldist.o $(LIBS) -o $(BDIR)/skelcurv
...
$(BDIR)/surfacerestoration:	$(CDIR)/surfacerestoration.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/mctopo3d.h $(IDIR)/mcindic.h $(IDIR)/mclifo.h $(IDIR)/mcfah.h $(IDIR)/lhisto.h $(IDIR)/llabelextrema.h $(IDIR)/lhtkern3d.h $(OBJ_COMMON) $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/surfacerestoration.c $(OBJ_COMMON) $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/surfacerestoration
...
$(BDIR)/genball:	$(CDIR)/genball.c $(IDIR)/mcimage.h $(IDIR)/lbresen.h $(IDIR)/ldraw.h $(OBJ_COMMON) $(ODIR)/lbresen.o $(ODIR)/ldraw.o $(ODIR)/mcliste.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/genball.c $(OBJ_COMMON) $(ODIR)/lbresen.o $(ODIR)/ldraw.o $(ODIR)/mcliste.o $(LIBS) -o $(BDIR)/genball
...
$(BDIR)/autocrop:	$(CDIR)/autocrop.c $(IDIR)/mcimage.h $(OBJ_COMMON) $(IDIR)/lcrop.h $(ODIR)/lcrop.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/autocrop.c $(OBJ_COMMON) $(ODIR)/lcrop.o $(LIBS) -o $(BDIR)/autocrop
...
$(BDIR)/cropondisk: $(CDIR)/cropondisk.c $(ODIR)/libcrop.o $(IDIR)/mccodimage.h $(OBJ_COMMON)
	$(CC) $(CCFLAGS) -I$(IDIR) -D_LARGEFILE64_SOURCE=1 -D_FILE_OFFSET_BITS=64 $< $(ODIR)/libcrop.o $(OBJ_COMMON) $(LIBS) -o $@

$(BDIR)/shrinkondisk: $(CDIR)/shrinkondisk.c $(ODIR)/libcrop.o $(OBJ_COMMON) $(IDIR)/mccodimage.h
	$(CC) $(CCFLAGS) -I$(IDIR) -D_LARGEFILE64_SOURCE=1 -D_FILE_OFFSET_BITS=64 $< $(ODIR)/libcrop.o $(OBJ_COMMON) $(LIBS) -o $@
...
$(BDIR)/recalagerigide_translateplane:	$(CDIR)/recalagerigide_translateplane.c $(IDIR)/lrecalagerigide_translateplane.h $(IDIR)/mcimage.h $(IDIR)/mclin.h $(IDIR)/mcpowell.h $(IDIR)/mcgeo.h $(ODIR)/mclin.o $(ODIR)/mcpowell.o $(ODIR)/lrecalagerigide_translateplane.o $(ODIR)/mcgeo.o $(OBJ_COMMON)
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/recalagerigide_translateplane.c $(ODIR)/mclin.o $(ODIR)/mcgeo.o $(ODIR)/mcpowell.o $(ODIR)/lrecalagerigide_translateplane.o $(OBJ_COMMON) $(LIBS) -o $(BDIR)/recalagerigide_translateplane
...
# HISTO
# *********************************
$(BDIR)/comphisto:	$(CDIR)/comphisto.c $(IDIR)/lcomphisto.h $(IDIR)/mcimage.h $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/comphisto.c $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/comphisto

$(BDIR)/countvalues:	$(CDIR)/countvalues.c $(IDIR)/lhisto.h $(IDIR)/mcimage.h $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/countvalues.c $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/countvalues

$(BDIR)/egalise:	$(CDIR)/egalise.c $(IDIR)/legalise.h $(IDIR)/mcfah.h $(IDIR)/mcimage.h $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/egalise.c $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/egalise

$(BDIR)/histo:	$(CDIR)/histo.c $(IDIR)/lhisto.h $(IDIR)/mcimage.h $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/histo.c $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/histo

$(BDIR)/histo2:	$(CDIR)/histo2.c $(IDIR)/lhisto.h $(IDIR)/mcimage.h $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/histo2.c $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/histo2

$(BDIR)/histoazimuth:	$(CDIR)/histoazimuth.c $(IDIR)/lhisto.h $(IDIR)/mcimage.h $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/histoazimuth.c $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/histoazimuth

$(BDIR)/histodist:	$(CDIR)/histodist.c $(IDIR)/lhisto.h $(IDIR)/mcimage.h $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/histodist.c $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/histodist

$(BDIR)/histoelevation:	$(CDIR)/histoelevation.c $(IDIR)/lhisto.h $(IDIR)/mcimage.h $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/histoelevation.c $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/histoelevation

$(BDIR)/histopgm:	$(CDIR)/histopgm.c $(IDIR)/lhisto.h $(IDIR)/mcimage.h $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/histopgm.c $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/histopgm

$(BDIR)/histolisse:	$(CDIR)/histolisse.c $(IDIR)/lhisto.h $(IDIR)/mcimage.h $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/histolisse.c $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/histolisse

$(BDIR)/histscal:	$(CDIR)/histscal.c $(IDIR)/lhistscal.h $(IDIR)/mcfah.h $(IDIR)/mcimage.h $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/histscal.c $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/histscal

$(BDIR)/histosieve:	$(CDIR)/histosieve.c $(IDIR)/lhisto.h $(IDIR)/mcimage.h $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/histosieve.c $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/histosieve

$(BDIR)/histstretch:	$(CDIR)/histstretch.c $(IDIR)/lhistscal.h $(IDIR)/mcfah.h $(IDIR)/mcimage.h $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/histstretch.c $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/histstretch

$(BDIR)/printhisto:	$(CDIR)/printhisto.c $(IDIR)/lhisto.h $(IDIR)/mcimage.h $(ODIR)/libpink.a
...
$(BDIR)/relabel:	$(CDIR)/relabel.c $(IDIR)/lhisto.h $(IDIR)/mcimage.h $(ODIR)/libpink.a
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/relabel.c $(ODIR)/libpink.a $(LIBS) -o $(BDIR)/relabel

$(BDIR)/seuilhisto:	$(CDIR)/seuilhisto.c $(IDIR)/lhisto.h $(IDIR)/mcimage.h $(ODIR)/libpink.a
...
$(BDIR)/deriche3d:	$(CDIR)/deriche3d.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lderiche.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/lderiche.o
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/deriche3d.c $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/lderiche.o $(LIBS) -o $(BDIR)/deriche3d
...
$(BDIR)/entropy:	$(CDIR)/entropy.c $(IDIR)/mcimage.h $(IDIR)/larith.h $(IDIR)/lhisto.h $(ODIR)/libpink.a
...
$(BDIR)/gaussianfilter:	$(CDIR)/gaussianfilter.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lderiche.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/lderiche.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/gaussianfilter.c $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/lderiche.o $(LIBS) -o $(BDIR)/gaussianfilter
...
$(BDIR)/laplacian:	$(CDIR)/laplacian.c $(IDIR)/mcimage.h $(IDIR)/mccodimage.h $(IDIR)/lderiche.h $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/lderiche.o 
	$(CC) $(CCFLAGS) -I$(IDIR) $(CDIR)/laplacian.c $(OBJ_COMMON) $(ODIR)/mccodimage.o $(ODIR)/lderiche.o $(LIBS) -o $(BDIR)/laplacian
