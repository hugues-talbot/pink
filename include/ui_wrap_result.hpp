...
#define UI_WRAP_RESULT_DEF_FOR_TYPE(image_type, n, text)                \
  def(fname, make_result< image_type,                                   \
...
#define UI_WRAP_RESULT(FNAME, FN, ARGS, DOC)                            \
  ...
  {                                                                     \
    const int FA = decompose<Fn>::arity;                                \
                                                                        \
    BOOST_PP_CAT(instance,BOOST_PP_COUNTER)< int_< FA - 1 > > wrapped_function; \
                                                                        \
...
// UI_WRAP_RESULT("greet", greet, (arg("image"), (arg("int"))) ,"WRITE ME!!");

// #undef BOOST_PP_COUNTER
// #define BOOST_PP_COUNTER 1

// UI_WRAP_RESULT("new_greet", greeter, (arg("image"), arg("int"), arg("connexity")=0) ,"READ ME!!");
