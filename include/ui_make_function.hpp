...
#undef error
#define error(msg) {stringstream fullmessage; fullmessage << "in ui_make_function.hpp: " << msg; call_error(fullmessage.str());}
...
// image_type make_function( const image_type& image , param_type0 param0 )
// {
//   image_type result;
//   result.copy(image);
//   if (!mcfunction(result , param0)) {
//     error("mcfunction failed");
//   }
//   return result;
// }
