...
// the date of generation: 2011-06-27T15:02:51Z
...
"If angle(C[j]-C[i], C[j]-C[k]) \n"         \
"\n"         \
"\n"         \
"Parameter  len is given in pixels, parameter  sharp in degrees.\n"         \
"\n"         \
...
#define doc__test_juliette__c__ "WRITE ME!!!\n"         \
"\n"
...
#define doc__GAwatershedDouble__c__ "WRITE ME!!!\n"         \
"\n"
...
#define doc__pgm2GA__c__ "WRITE ME!!!\n"         \
"\n"
...
"(graph.ga) into its representation (depending on the parameter\n"         \
"type) in the Khalimsky grid, stored as a pgm image\n"         \
...
#define doc__0000__c__ "  index Main Page\n"         \
"\n"         \
...
"'dependencies'.\n"         \
"\n"         \
"The project management is alpha-hosted at \n"         \
"BerliOs.\n"         \
"\n"         \
"\n"         \
...
#define doc__ppm2GA__c__ "WRITE ME!!!\n"         \
"\n"
...
"\n"         \
"Usage: skel2graph in.skel [mode] out.graph\n"         \
"\n"         \
"Description:\n"         \
"Generation of a graph from a curvilinear skeleton.\n"         \
"\n"         \
...
"\n"         \
"Usage: 3dkhalimskize in.pgm {6|26|h|m|M|a} out.pgm\n"         \
"\n"         \
"Description:\n"         \
"Converts a 3D image into a 3D Khalimsky order.\n"         \
"\n"         \
