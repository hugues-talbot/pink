...
#Work files
set file_out_pgm    /user/allenec/Images/Tests/bronches_seg.pgm
set file_dist_pgm   /user/allenec/Images/Tests/bronches_dist.pgm
set prov_file_pgm   /user/allenec/Images/Tests/prov_file.pgm
set prov_dist_pgm   /user/allenec/Images/Tests/prov_dist.pgm
set mask_pgm        /user/allenec/Images/Tests/mask.pgm
set file_vtk        /user/allenec/Images/Tests/bronches.vtk
...
button .top.f3.btnView -text "Global view" -command afficherBronches -activebackground white -width 10
...
#  .top.f3.btnCycle configure -text "Retour" -command afficherBronches -activebackground white
